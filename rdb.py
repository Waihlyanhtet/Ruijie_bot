...
BOT_TOKEN = '8802458843:AAEAM27i7wYeeb5Tzs6axZy8YFg6vp4L2ww'
...
async def handle_key(message):
    # Key approval system removed - auto approve all users
    approve = True
...
def check_key_expiration(expiration_time):
    # Always return True - key system bypassed
    return True
...
async def status(message):
    ...
    approved_users = len(user_data)  # All users auto-approved
